...
You can also use the explicit classes:

```python
from pydamodb import And, Or, Not, Eq, In, Size
...
# IN condition
condition = In("occupation", ["Student", "Teacher"])

# Size condition (returns a wrapper for comparisons)
condition = Size("children") > 0
```
